...
export default function Index() {
  ...
  return (
    <View className="flex-1 bg-zinc-50 dark:bg-zinc-950  justify-between py-16">
      ...
      <View className="items-center my-10">
        <View className="w-48 h-48 rounded-full bg-emerald-500/10 items-center justify-center">
