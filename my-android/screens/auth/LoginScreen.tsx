...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.log("Успішний вхід, Token:", res.token);

      router.replace("/");
    } catch (e: any) {
      console.log("Login error:", e);
      const errorMsg = e.data?.errors?.Email || "Невірний логін або пароль";
      alert(errorMsg);
    }
  };

  return (
    <View className="flex-1 bg-zinc-50 dark:bg-zinc-950 px-6">
